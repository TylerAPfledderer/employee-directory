...
fetch("https://randomuser.me/api/?results=12&inc=name,location,email,dob,cell,picture,nat&nat=us,au,br,ca,ch&noinfo")
  ...
  modalOverlay.innerHTML = `
		<section class="employee-modal employee-card">
			...
			<div class="employee-modal__upper">
					<img src="${picture.large}" alt="Large Picture of ${name.first} ${name.last}" class="employee-card__img employee-modal__img">
			...
			<div class="employee-modal__lower">
					...
					<address class="employee-modal__address">${street.number} ${street.name}, ${state} ${postcode}</address>
...
function employeeSearch() {
  ...
  employees.forEach((employee, index) => {
    ...
    const employeeCard = cards[index];
